package com.ideaflow.yunyu.module.post.site.service;
...
import com.ideaflow.yunyu.module.post.site.vo.SiteTagLinkResponse;
import com.ideaflow.yunyu.module.post.site.vo.SiteTopicLinkResponse;
...
/**
 * 前台文章服务类。
 * 作用：承接前台文章列表、详情、访问控制校验、浏览量上报以及文章卡片聚合等能力。
 */
@Service
public class PostSiteService {
     ...
     */
    public PostSiteService(PostMapper postMapper,
     ...
     * @return 推荐文章列表
     */
    public List<SitePostSummaryResponse> listRecommendedPosts() {
     ...
     * @return 最新文章列表
     */
    public List<SitePostSummaryResponse> listLatestPosts() {
        List<PostEntity> postEntities = postMapper.selectList(new LambdaQueryWrapper<PostEntity>()
                .eq(PostEntity::getDeleted, 0)
                .eq(PostEntity::getStatus, "PUBLISHED")
                .orderByDesc(PostEntity::getPublishedAt)
