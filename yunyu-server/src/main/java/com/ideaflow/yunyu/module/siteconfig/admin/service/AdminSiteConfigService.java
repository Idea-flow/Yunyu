package com.ideaflow.yunyu.module.siteconfig.admin.service;
...
public class AdminSiteConfigService {
     ...
     */
    public AdminSiteConfigService(SiteConfigService siteConfigService, ObjectMapper objectMapper) {
    ...
    private SiteConfigEntity findConfigByKey(String configKey) {
        return siteConfigService.getConfigByKey(configKey);
    }
    ...
    private JsonNode readJsonNode(String configJson) {
        return siteConfigService.readJsonNode(configJson);
    }
